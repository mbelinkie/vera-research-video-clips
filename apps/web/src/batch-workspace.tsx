...
export function BatchWorkspace({
  ...
  useEffect(() => {
    onUnreadActivityChange(activity?.unreadCount ?? 0);
  }, [activity?.unreadCount, onUnreadActivityChange]);
        ...
        <>
          ...
          <div hidden={destination !== "clips"}>
            <ClipQueue
              ...
              projectId={projectId}
              request={request}
              onOpenSourceClip={(clip, fallbackNotice) =>
                onOpenSourceClip({
                  projectId,
  ...
  return (
    <article className="queue-card" aria-label="Project keywords">
      ...
      <p className="muted">
        ...
        clip tags, and no transcript-match evidence exists until the scanning
            ...
            <div className="review-item" key={keyword.id}>
              ...
              <div aria-label={`Aliases for ${keyword.label}`}>
                {keyword.aliases.map((alias) => (
                  <span className="count-badge" key={alias.id}>
  ...
  return (
    <article className="queue-card activity-inbox-card">
      <div className="action-row">
        <h3>
          Activity for you{" "}
          <span className="count-badge">{activity?.unreadCount ?? 0}</span>
        </h3>
      ...
      <p className="muted">
        Review and triage changes on videos you flagged, newest first.
      </p>
